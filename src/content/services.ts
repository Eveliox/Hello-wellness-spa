...
export const services: ServiceContent[] = [
  ...
  },
  {
    ...
    summary:
      "Targeted peptide protocols prescribed and administered in-clinic under APRN oversight. Lot-traceable sourcing, clear labeling, and handling guidance at every visit.",
    heroImage: "/peptides.jpg",
    startingAt: { amount: 59 },
    benefits: [
      "APRN-directed candidacy review, dosing, and side-effect monitoring",
      "Lot-traceable sourcing from accredited compounding pharmacies",
      "Clear dosing schedule with labeled take-home vials when appropriate",
      "Integrated with your labs, IV support, and hormone care at Hello You",
    ],
    idealFor: [
      "Patients exploring recovery peptides like BPC-157 or GHK-Cu with real medical oversight",
      "Adults considering GLP-1 or growth-hormone secretagogue support instead of DIY sources",
      "Anyone who wants peptide therapy dosed to their labs and monitored on a defined cadence",
    ],
    sessionNote: "Initial visits cover candidacy, goals, and any labs needed before a protocol is prescribed.",
    ctaNote: "In-clinic administration in SW Miami. No shipping, no self-sourced vials.",
    faqIds: ["peptide-safety", "peptide-consult", "payment"],
    gettingStartedSteps: [
      {
        title: "Consultation",
        body: "Meet with an APRN to review your goals, health history, and which peptide protocols make sense for you. Honest candidacy conversation, no pressure to start same-day.",
      },
      {
        title: "Labs and protocol",
        body: "We order labs when relevant, review results against your symptom picture, and prescribe a personalized protocol with a clear dosing schedule.",
      },
      {
        title: "In-clinic dosing and follow-up",
        body: "Peptides are administered in-clinic under APRN supervision, or dispensed as properly-labeled take-home doses for a defined window. Follow-up visits check response and adjust as needed.",
      },
    ],
