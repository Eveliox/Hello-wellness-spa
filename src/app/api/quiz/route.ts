    ...
    await sendEmail({
      ...
      html: `
        <div style="font-family:system-ui,-apple-system,sans-serif;max-width:560px">
          ...
          <p>
            <a href="${escapeHtml(site.bookingUrl)}" style="display:inline-block;padding:10px 18px;border-radius:999px;background:#121212;color:#fff;text-decoration:none">Book a consult</a>
            &nbsp;
