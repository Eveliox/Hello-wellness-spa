    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-chrome text-on-chrome">
      <Container className="flex h-16 items-center justify-between gap-4 lg:h-[4.25rem]">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          <Button href={site.portalUrl} variant="ghostInverse" size="sm">
            Client portal
          </Button>
          <Button href={site.bookingUrl} variant="inverse" size="sm">
            Book now
          </Button>
        </div>
      ...
      >
        <div className="mx-auto flex max-w-lg flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-2 pt-2">
            <Button href={site.portalUrl} variant="ghostInverse" className="w-full border border-white/20">
              Portal
            </Button>
            <Button href={site.bookingUrl} variant="inverse" className="w-full">
              Book now
            </Button>
          </div>
